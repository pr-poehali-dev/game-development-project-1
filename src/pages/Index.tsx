...
const story: Record<string, StoryNode> = {
  ...
  why: {
    id: 'why',
    speaker: 'affogato',
    text: '*Подходит ближе* Потому что ты никогда не замечал меня. Твой холодный взгляд... он ранил меня каждый день. Но здесь, наедине, ты наконец-то увидишь, как сильно я тебя люблю.',
